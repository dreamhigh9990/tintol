...
class SyncGiftTransactions extends Command
{
     ...
     * @var string
     */
    protected $description = 'Sync Tintol Gift Card Transactions with Tintol Platform';
    ...
    public function handle()
    {
        ...
        $this->info(count($reloadlyGiftCardTransactions)." Tintol Gift Transactions Found");
        ...
        $this->line("Getting Tintol Gift Card Transactions that are PENDING");
        GiftCardTransaction::where('status','PENDING')->chunk(100, function($giftTransactions)
        {
            $this->info(count($giftTransactions)." Tintol Gift Transactions Found.");
        ...
        $this->line("****************************************************************");
        $this->info("All Tintol Gift Transactions Synced !!! ");
        $this->line("****************************************************************");
        $this->line("");
    }
}
