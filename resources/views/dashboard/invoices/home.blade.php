                            ...
                            <table class="table zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($invoice['type'] === 'Topup'||'GiftCard')
                                        ...
                                        <td>
                                            ...
                                            @if(Auth::user()['user_role']['name'] === 'ADMIN'||'CUSTOMER')
                                        ...
                                        <td>
                                            @if(Auth::user()['user_role']['name'] === 'ADMIN'||Auth::user()['user_role']['name'] === 'RESELLER'||Auth::user()['user_role']['name'] === 'CUSTOMER')
                                            <button type="button" class="btn btn-xs btn-icon btn-outline-primary mr-0 waves-effect waves-light" data-toggle="modal-feed" data-target="#modal_sm" data-feed="invoices/{{ $invoice['id'] }}">E-mail SMS</button>
                                            <!-- <button type="button" class="btn btn-xs btn-icon btn-outline-primary mr-0 waves-effect waves-light" data-toggle="modal-feed" data-target="#modal_sm" data-feed="invoices/{{ $invoice['id'] }}">SMS</button> -->
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
