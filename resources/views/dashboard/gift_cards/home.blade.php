                                    ...
                                    @if(Auth::user()->hasPermission('READ'))
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-xs btn-icon btn-outline-primary mr-0 waves-effect waves-light" data-toggle="modal-feed" data-target="#modal_sm">Order</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
