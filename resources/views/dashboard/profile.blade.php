                ...
                <form class="form" action="/profile" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                ...
                                <label for="first-name-floating-icon">Officer's name</label>
                            </div>
                        </div>
                        <div class="col-md-4 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                ...
                                <label for="username-floating-icon">Manager's first name</label>
                            </div>
                        </div>
                        <div class="col-md-4 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                <input type="text" id="company-floating-icon" class="form-control" placeholder="Company" name="Company" value="{{ @Auth::user()[''] }}">
                                <div class="form-control-position">
                                    <!-- <i class="feather icon-hash"></i> -->
                                </div>
                                <label for="username-floating-icon">Company</label>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                <input type="text" id="phone-floating-icon" class="form-control" placeholder="SERET" name="seret" value="{{ @Auth::user()[''] }}">
                                <div class="form-control-position">
                                    <i class="feather icon-hash"></i>
                                </div>
                                <label for="phone-floating-icon">SERET</label>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                <input type="text" id="phone-floating-icon" class="form-control" placeholder="VAT Number" name="vatnumber" value="{{ @Auth::user()[''] }}">
                                <div class="form-control-position">
                                    <i class="feather icon-hash"></i>
                                </div>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                <input type="text" id="phpne-floating-icon" class="form-control" placeholder="IBAN Number" name="iban" value="{{ @Auth::user()[''] }}">
                                <div class="form-control-position">
                                    <i class="feather icon-hash"></i>
                                </div>
                                <label>IBAN</label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <div class="form-label-group position-relative has-icon-left">
                                <input type="text" id="state" class="form-control" name="state" placeholder="adress" value="{{ @Auth::user()[''] }}">
                                <div class="form-control-position">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    <h6 class="media-heading" stal>K-bis</h6>
                                    <div class="col-12 d-flex mt-1 px-0">
                                        <button type="button" id="dpz-mini-logo" class="btn btn-primary d-none d-sm-block mr-75 waves-effect waves-light">Insert <i class="fa fa-spinner fa-spin d-none"></i></button>
                                    ...
                                    <div class="box-shadow p-3 border">
                                        <a class="col-sm-3 control-label" href="#">
                                            <img src="{{ @OTIFSolutions\Laravel\Settings\Models\Setting::get('mini_logo') }}" alt="K-bis" class="users-avatar-shadow rounded" width="90" height="90">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    <h6 class="media-heading">ID Card</h6>
                                    <div class="col-12 d-flex mt-1 px-0">
                                        <button type="button" id="dpz-mini-logo" class="btn btn-primary d-none d-sm-block mr-75 waves-effect waves-light">Insert <i class="fa fa-spinner fa-spin d-none"></i></button>
                                        <button type="button" class="btn btn-primary d-block d-sm-none mr-75 waves-effect waves-light"><i class="feather icon-edit-1"></i></button>
                                        <button type="button" data-toggle="post-feed" data-feed="/settings/mini_logo/remove" class="btn btn-outline-danger d-none d-sm-block waves-effect waves-light">Remove</button>
                                    ...
                                    <div class="box-shadow p-3 border">
                                        <a class="col-md-3 control-label" href="#">
                                            <img src="{{ @OTIFSolutions\Laravel\Settings\Models\Setting::get('mini_logo') }}" alt="ID Card" class="users-avatar-shadow rounded" width="90" height="90">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    <h6 class="media-heading">Company Logo</h6>
                                    <div class="col-12 d-flex mt-1 px-0">
                                    ...
                                    <div class="box-shadow p-3 border">
                                        <a class="col-md-3 control-label" href="#">
                                            <img src="{{ @OTIFSolutions\Laravel\Settings\Models\Setting::get('') }}" alt="Company Logo" class="users-avatar-shadow rounded" width="90" height="90">
                                        </a>
                                    </div>
                                </div>
                            </div>
