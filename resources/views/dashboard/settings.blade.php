                    ...
                    <form class="form" action="/settings" method="POST">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="settings" aria-labelledby="settings-tab" role="tabpanel">
                                ...
                                <div class="row align-items-center mb-1">
                                    <div class="col-auto">
                                        <h4 class="card-title"><i class="feather icon-circle"></i> Tintol</h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 col-6">
                                        <div class="form-label-group position-relative">
                                            ...
                                            <label for="reloadly-api-key">Tintol Api Key</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-6">
                                        <div class="form-label-group position-relative">
                                            ...
                                            <label for="reloadly-api-secret">Tintol Api Secret</label>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="custom-control custom-switch custom-switch-primary switch-md">
