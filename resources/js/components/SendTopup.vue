        ...
        <div class="card-content">
            <div class="card-body">
                <loading :active.sync="isLoading"
                    ...
                    <h6 style="text-align: center">Number</h6>
                ...
                <div v-if="detected">
                    <!-- <div class="row justify-content-center align-items-center">
                      ...
                      <h6 style="text-align: center">Method of payment</h6>
                     <div class="row justify-content-center align-items-center">
                        
                        <div class=" pl-1 pr-1">
                            <select style="width: 261px" class="custom-select form-control required" id="operator" name="operator" v-model="selectedOperator">
                                <option v-for="operator in operators" :value="operator">{{ "Method of payment" }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <h5 style="text-align:center">VAT rate to apply(%)</h5>
                        <div class="row justify-content-center align-items-center pb-1">
                        ...
                        <h5 style="text-align:center">price to pay (excl. VAT)</h5><br/>
                        <h5 style="text-align:center">price to be paid to the customer (including VAT)</h5><br/>
                        <h5 style="text-align:center">Profit realized (HT)</h5><br/>                        
                    </div>
...
export default {
    ...
    methods: {
        handleComplete: function(){
            ...
            if(this.intInput.isValidNumber()) {
                this.isLoading = true;
                if (this.send == "0") {
                    toastr.error('Please Login/Register First');
                ...
                toastr.error('Invalid Number Provided');
        },
